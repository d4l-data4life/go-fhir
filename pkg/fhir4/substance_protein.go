...
// SubstanceProtein represents a SubstanceProtein is defined as a single unit of a linear amino acid sequence
...
// SubstanceProteinSubunit represents this subclause refers to the description of each subunit constituting the SubstanceProtein
